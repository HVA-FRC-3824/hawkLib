...
public class Zone {
    ...
    public static Trigger fromCorners(Supplier<Pose2d> poseSupplier,
        Translation2d upperRightCorner, Translation2d lowerLeftCorner) {
    ...
    public static Trigger fromAllianceWall(Supplier<Pose2d> poseSupplier, Distance dist) {
        ...
        return fromCorners(poseSupplier,
