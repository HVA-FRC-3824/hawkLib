...
public class SwerveDriveSimulation extends AbstractDriveTrainSimulation {
  ...
  public SwerveDriveSimulation(DriveTrainSimulationConfig config, Pose2d initialPoseOnField) {
    ...
    this.moduleSimulations =
        Arrays.stream(config.swerveModuleSimulationFactories)
            .map(Supplier::get)
   ...
   * @see
   *     org.ironmaple.simulation.drivesims.configs.SwerveModuleSimulationConfig#maximumGroundSpeed()
   */
   ...
   * @see
   *     org.ironmaple.simulation.drivesims.configs.SwerveModuleSimulationConfig#maxAcceleration(Mass,
   *     int, Current)
   */
