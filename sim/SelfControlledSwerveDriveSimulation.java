...
public class SelfControlledSwerveDriveSimulation {
  ...
  public void resetGyro(Rotation2d rotation) {
    ...
    this.poseEstimator.resetRotation(rotation);
  }
  ...
  public ChassisSpeeds getMeasuredSpeedsFieldRelative(boolean useGyroForAngularVelocity) {
    ...
    speeds =
        ChassisSpeeds.fromRobotRelativeSpeeds(speeds, getOdometryEstimatedPose().getRotation());
    return speeds;
  }
  ...
  public ChassisSpeeds getMeasuredSpeedsRobotRelative(boolean useGyroForAngularVelocity) {
    ...
    return new ChassisSpeeds(
        ...
        useGyroForAngularVelocity
            ? swerveDriveSimulation.gyroSimulation.getMeasuredAngularVelocity().in(RadiansPerSecond)
  ...
  public SelfControlledSwerveDriveSimulation withSteerPID(PIDController steerController) {
    for (SelfControlledModuleSimulation moduleSimulation : moduleSimulations)
      moduleSimulation.withSteerPID(
          new PIDController(
              steerController.getP(), steerController.getI(), steerController.getD()));
    return this;
  }
    ...
    public void runModuleState(SwerveModuleState setPoint) {
      final double
          cosProjectedSpeedMPS =
              SwerveStateProjection.project(setPoint, instance.getSteerAbsoluteFacing()),
          driveWheelVelocitySetPointRadPerSec =
              cosProjectedSpeedMPS / instance.config.WHEEL_RADIUS.in(Meters);

      driveMotor.requestVoltage(
          instance.config.driveMotorConfigs.calculateVoltage(
      ...
      steerMotor.requestVoltage(
          Volts.of(
              steerController.calculate(
                  ...
                  desiredModuleFacing.getRadians())));
    }
    ...
    public SwerveModulePosition getModulePosition() {
      return new SwerveModulePosition(
          instance.getDriveWheelFinalPosition().in(Radians)
              * instance.config.WHEEL_RADIUS.in(Meters),
